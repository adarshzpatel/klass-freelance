  ...
  return (
      <div className="flex flex-col gap-4">
        ...
        <SocialLink
              ...
              />
              <SocialLink link="https://rinkeby.etherscan.io/address/0x949c45049a9cdb33718539638fC867Ea919EB50C" text="View on Etherscan"/>
      
          {txHash && <a href={"https://rinkeby.etherscan.io/" + txHash} className='underline underline-offset-2 text-sky-500 text-center'> View Transaction on etherscan </a>}
      </div>
    );
